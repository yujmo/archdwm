...
/* tagging */
static const char *tags[] = { "桌面"};

static const Rule rules[] = {
	/* class      instance    title       tags mask     isfloating   monitor */
	{ "Gimp",     NULL,       NULL,       0,            True,        -1 },
	{ "Firefox",  NULL,       NULL,       1 << 2,       False,       -1 },
	{ "Thunderbird", NULL,    NULL,       1 << 8,       True,        -1 },
};
...
static const char *startffox[]  = {"firefox", NULL};
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_c,      spawn,          {.v = startchrom } },
	...
	{ MODKEY,                       XK_o,      spawn,          {.v = startffox } },//firefox
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
